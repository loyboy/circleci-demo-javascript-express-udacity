...
This project was built from a MERN Starter kit (Just Checking Trigger). Discussions still [active here](https://hashnode.com/n/mern). MERN is Mongo, Express, React and NodeJS.
